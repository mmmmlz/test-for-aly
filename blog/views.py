...
from read_statistics.utils import read_statisics_once_read
...
def get_blog_list_common_data(request,blog_all_list):
    paginator = Paginator(blog_all_list, settings.EACH_PAGE_BLOG_NUM)  # 每5篇进行分页
...
def blog_detail(request, blog_pk):
    ...
    read_cookie_key = read_statisics_once_read(request,blog)
